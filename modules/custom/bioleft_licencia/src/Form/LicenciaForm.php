...
/**
 * Form controller for Licencia edit forms.
 *
 * @ingroup bioleft_licencia
 */
class LicenciaForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        drupal_set_message($this->t('Created the %label Licencia.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        drupal_set_message($this->t('Saved the %label Licencia.', [
          '%label' => $entity->label(),
        ]));
    }
    $form_state->setRedirect('entity.licencia.canonical', ['licencia' => $entity->id()]);
  }
